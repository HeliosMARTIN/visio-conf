...
export default function ChannelMembers({ members, currentUserId, isAdmin, onInviteMember }: ChannelMembersProps) {
    ...
    <div className={styles.membersContainer}>
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            {isAdmin && (
              <button className={styles.inviteButton} onClick={onInviteMember}>
                <UserPlus size={16} />
            ...
            <div className={styles.membersSection}>
              <h4 className={styles.sectionTitle}>Administrateurs</h4>
              {admins.map((member) => (
                <div key={member.id} className={styles.memberItem}>
                  ...
                  <div className={styles.memberInfo}>
                    <span className={styles.memberName}>
                      ...
                      {member.userId === currentUserId && <span className={styles.youBadge}>Vous</span>}
                    </span>
                    <span className={styles.memberRole}>
                      <Crown size={12} className={styles.adminIcon} />
                      Administrateur
                    </span>
                  </div>
                </div>
            ...
            <div className={styles.membersSection}>
              ...
              {regularMembers.length === 0 ? (
                <p className={styles.emptyMembers}>Aucun membre régulier</p>
              ) : (
                regularMembers.map((member) => (
                  <div key={member.id} className={styles.memberItem}>
                    ...
                    <div className={styles.memberInfo}>
                      ...
                      <span className={styles.memberRole}>Membre</span>
                    </div>
                  </div>
                ))
              )}
