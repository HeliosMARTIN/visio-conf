...
export default function UserInfo({ user, currentUserEmail, variant = 'default' }: UserInfoProps) {
    ...
    return (
        <li className={styles.userInfo}>
            <div className={styles.userInfoContent} onClick={handleMessage} style={{ cursor: 'pointer' }}>
                <Image
                    src={`https://visioconfbucket.s3.eu-north-1.amazonaws.com/${user.picture}`}
                    alt={`${user.firstname} profile picture`}
                    width={50}
