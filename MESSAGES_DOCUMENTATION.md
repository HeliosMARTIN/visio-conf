...
| **file_upload_request**  | { fileId: string, name: string, size: number, type: string, fileData: Buffer } | { name: "image.png", size: 2048, type: "image/png", fileData: <Buffer>} | FilePage (frontend)   | FileService (backend) |
